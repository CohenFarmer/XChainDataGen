...
class AcrossDecoder(BaseDecoder):
    ...
    def decode_event(self, contract: Contract, log: dict):
        ...
        elif log["topics"][0] == "0x571749edf1d5c9599318cdbc4e28a6475d65e87fd3b2ddbe1e9a8d5e7a0f0ff7":
            return contract.events.FilledV3Relay().process_log(log)['args']
        elif log["topics"][0] == "0xf8bd640004bcec1b89657020f561d0b070cbdf662d0b158db9dccb0a8301bfab":
