...
class RoninDecoder(BaseDecoder):
    ...
    def decode_event(self, contract: Contract, log: dict):
        ...
        elif log["topics"][0] == "0x8d20d8121a34dded9035ff5b43e901c142824f7a22126392992c353c37890524":
            return contract.events.Deposited().process_log(log)['args']
        elif log["topics"][0] == "0xf313c253a5be72c29d0deb2c8768a9543744ac03d6b3cafd50cc976f1c2632fc":
            return contract.events.WithdrawalRequested().process_log(log)['args']
        elif log["topics"][0] == "0x21e88e956aa3e086f6388e899965cef814688f99ad8bb29b08d396571016372d":
