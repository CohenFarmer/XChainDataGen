...
class CCTPDepositForBurn(Base):
    ...
    def __init__(
        self, blockchain, transaction_hash, nonce, depositor, burn_token, recipient, dst_blockchain, amount
    ):
    ...
    def __repr__(self):
        return f"<CCTPDepositForBurn {self.blockchain} {self.transaction_hash} {self.nonce} {self.depositor} {self.burn_token} {self.recipient} {self.dst_blockchain} {self.amount}>"
...
class CCTPMessageReceived(Base):
    ...
    def __init__(
        self, blockchain, transaction_hash, nonce, src_blockchain, input_token, depositor, recipient, amount
    ):
        self.blockchain = blockchain
        self.transaction_hash = transaction_hash
        self.nonce = nonce
    ...
    def __repr__(self):
        return f"<CCTPMessageReceived {self.blockchain} {self.transaction_hash} {self.nonce} {self.src_blockchain} {self.input_token} {self.depositor} {self.recipient} {self.amount}>"


class CCTPBlockchainTransaction(Base):
    ...
    def __repr__(self):
        return f"<CCTPBlockchainTransaction(blockchain={self.blockchain}, transaction_hash={self.transaction_hash}, block_number={self.block_number}, timestamp={self.timestamp} from_address={self.from_address}, to_address={self.to_address}, status={self.status})>"
