...
def test_extract_data():
    ...
    assert len(events) == 107, "Expected 107 events in CCIPSendRequested table after extraction."
    ...
    assert len(transactions) == 107, "Expected 107 events in CCIPCrossChainTransactions table after extraction."
