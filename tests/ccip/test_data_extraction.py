...
def test_extract_data():
    args = argparse.Namespace(
        blockchains=["ethereum", "arbitrum", "avalanche", "polygon", "optimism", "bnb", "base", "linea", "scroll"],
        bridge="ccip",
    ...
    from repository.ccip.repository import CCIPSendRequestedRepository
    from repository.ccip.repository import CCIPExecutionStateChangedRepository
    ...
    assert len(events) == 163, "Expected 163 events in CCIPExecutionStateChanged table after extraction."
    ...
    assert len(transactions) == 59, "Expected 59 events in CCIPCrossChainTransactions table after extraction."
