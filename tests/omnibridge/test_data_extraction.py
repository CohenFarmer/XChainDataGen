...
def test_extract_data():
    ...
    from repository.omnibridge.repository import OmnibridgeUserRequestForSignatureRepository
    from repository.omnibridge.repository import OmnibridgeRelayedMessageRepository
    from repository.omnibridge.repository import OmnibridgeUserRequestForAffirmationRepository
    from repository.omnibridge.repository import OmnibridgeAffirmationCompletedRepository
    from repository.omnibridge.repository import OmnibridgeTokensBridgedRepository
    from repository.omnibridge.repository import OmnibridgeTokensBridgingInitiatedRepository
    ...
    assert len(events) == 51, "Expected 51 events in OmnibridgeUserRequestForSignature table after extraction."
    ...
    assert len(events) == 13, "Expected 13 events in OmnibridgeRelayedMessage table after extraction."
    ...
    assert len(events) == 53, "Expected 53 events in OmnibridgeUserRequestForAffirmation table after extraction."
    ...
    assert len(events) == 12, "Expected 12 events in OmnibridgeAffirmationCompleted table after extraction."
    ...
    assert len(events) == 75, "Expected 75 events in OmnibridgeTokensBridged table after extraction."
    ...
    assert len(events) == 79, "Expected 79 events in OmnibridgeTokensBridgingInitiated table after extraction."
    ...
    from repository.omnibridge.repository import OmnibridgeCrossChainTransactionsRepository
    from repository.omnibridge.repository import OmnibridgeOperatorTransactionsRepository
    from repository.database import DBSession
    ...
    assert len(transactions) == 97, "Expected 97 events in OmnibridgeCrossChainTransactions table after extraction."
    ...
    assert len(operator_transactions) == 156, "Expected 156 events in OmnibridgeOperatorTransactions table after extraction."
