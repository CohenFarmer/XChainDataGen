...
def test_extract_data():
    ...
    from repository.ronin.repository import RoninDepositRequestedRepository
    from repository.ronin.repository import RoninWithdrawalRequestedRepository
    ...
    assert len(events) == 49, "Expected 49 events in RoninWithdrawalRequested table after extraction."
    ...
    assert len(transactions) == 70, "Expected 70 events in RoninCrossChainTransactions table after extraction."
